...
import 'package:Easy_Shopping/AllPdfList.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showPdfList() async {
    ...
    if (res.statusCode == 200) {
      ...
      store.dispatch(PdfListAction(body['pdfBooks']));
    } else if (res.statusCode == 401) {
      Navigator.push(context, SlideLeftRoute(page: ErrorLogIn()));
    } else {
      Fluttertoast.showToast(
    ...
    store.dispatch(PdfListLoadingAction(false));
  }
            ...
            body: SafeArea(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              greeting,
                              style: TextStyle(color: Color(0xFFFFFFFF), fontFamily: "Poppins", fontSize: 20, fontWeight: FontWeight.w700),
                            ),
                            Text(
                              userName,
                              style: TextStyle(color: Color(0xFFFFFFFF), fontFamily: "Poppins", fontSize: 20, fontWeight: FontWeight.w700),
              ...
              width: MediaQuery.of(context).size.width / 3,
                  ...
                  store.state.categoryLoading
                      ? Center(child: Container(margin: EdgeInsets.only(top: 50, bottom: 50), child: CircularProgressIndicator()))
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            Navigator.push(context, SlideLeftRoute(page: CategoryPage()));
                                          },
                                          child: Text(
                                            "See All",
                                            maxLines: 1,
                                            textAlign: TextAlign.left,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(fontSize: 12, color: appColor.withOpacity(0.7), fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      ),
                                      // Container(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return
                                          ...
                                          children: <Widget>[
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                Navigator.push(context, SlideLeftRoute(page: CategoryProducts(store.state.categoryList[index])));
                                              },
                                              child: Container(
                                                //width
                                                child: Column(
                                                  ...
                                                  children: <Widget>[
                                                    Container(
                                                      ...
                                                      child:
                                                          ...
                                                          //     ?
                                                          Image.network(
                                                        CallApi().getUrl() + store.state.categoryList[index]['categoryImage'],
                                                        fit: BoxFit.cover,
                                                      ),
                                                      // : CachedNetworkImage(
                                                    ...
                                                    Container(
                                                      alignment: Alignment.center,
                                                      margin: EdgeInsets.only(left: 15, right: 10, top: 6, bottom: 6),
                                                      child: Text(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push( context, SlideLeftRoute(page: AllPdfList()));
                            },
                            child: Text(
                              "See All",
                              maxLines: 1,
